...
- 单用例超时：90000ms，可通过 `QUORUMMIND_LIVE_AUDIT_TIMEOUT_MS` 调整。
- 单 provider 请求超时：30000ms，可通过 `QUORUMMIND_LIVE_PROVIDER_TIMEOUT_MS` 调整。
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | ---: | --- |
| tenant-zh-fast | zh | fast | live | passed | 9 | 100% | 100% | true | 通过 | 81 | 22 | 69289 | - |
