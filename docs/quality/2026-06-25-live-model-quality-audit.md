...
- 本套件可运行用例：4 个；本轮实际运行：4 个；预估模型调用预算：36 次。
- 用例过滤：未启用，按套件顺序运行。
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | ---: | ---: | ---: | --- |
| tenant-zh-fast | zh | fast | live | passed | 9 | 100% | 100% | true | 通过 | 81 | 44 | 77085 | - |
| services-zh-fast | zh | fast | live | passed | 9 | 100% | 100% | true | 通过 | 82 | 0 | 77369 | - |
| agent-framework-zh-fast | zh | fast | live | passed | 9 | 100% | 100% | true | 通过 | 73 | 67 | 62114 | - |
| generic-zh-fast | zh | fast | live | passed | 9 | 100% | 100% | true | 通过 | 79 | 44 | 79974 | - |
