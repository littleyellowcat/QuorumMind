...
export function apiSecurityPosture(env: Env) {
  ...
  return {
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/providers/probe", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/providers/route", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/quality/eval", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/repo/workspace", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/agent-runs/audit", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/agent-runs/:id/audit", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/agent-runs/audit/diff", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/permissions/audit", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/permissions/lifecycle", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/permissions/approvals/:id/reply", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/permissions/approvals/:id/revoke", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/tools/manifests", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/tools/read-only", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/github/run", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/github/e2e", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/team/workspaces", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "GET", path: "/api/team/workspaces/:id", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/team/access", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/team/adr-approvals", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
      { method: "POST", path: "/api/team/adr-approvals/:id/reply", documented: true, authentication: policy.authenticationRequired ? "required" : "optional" },
