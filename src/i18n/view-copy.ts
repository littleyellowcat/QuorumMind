...
export const appCopy = {
  en: {
    ...
    productKind: "Auditable Decision Room",
    language: "Interface language",
    headline: "Use multi-model collaboration to make auditable technical decisions.",
    sublead:
      "Enter an architecture review, Agent-system design request, or complex technical decision. QuorumMind organizes models and agents to discuss, challenge, revise, and produce a clear conclusion, execution path, risks, and exportable audit trail.",
    ...
    landingHeadline: "Review complex technical choices in an auditable decision room.",
    landingSublead:
      "QuorumMind lets models and agents draft independently, challenge each other, revise toward consensus, and produce traceable ADRs, blueprints, risk ledgers, permission audits, and final PDFs.",
    landingMetricAlgorithms: "9 lenses",
    landingMetricAlgorithmsLabel: "Borda / AHP / TOPSIS and risk lenses",
    landingMetricAgents: "5+ seats",
    landingMetricAgentsLabel: "Agents, providers, CLI and GitHub skeletons",
    ...
    landingTraceText: "See source status, model traces, consensus rounds, permission gates, config summaries, and fallback labels.",
    ...
    permissionAuditCenter: "Permission audit",
    noLiveModel:
  ...
  zh: {
    productName: "QuorumMind",
    productKind: "可审计多模型决策室",
    language: "界面语言",
    headline: "用多模型协作生成可审计的技术决策。",
    sublead: "输入架构评审、Agent 系统设计或复杂技术决策，QuorumMind 会组织多个模型/智能体进行讨论、质询和修订，最终给出清晰结论、执行路径、风险提醒和可导出的审计轨迹。",
    landingNavDecision: "决策室",
    landingNavBlueprint: "方案蓝图",
    landingNavEval: "评估",
    landingNavExport: "导出",
    landingKicker: "多智能体决策智能",
    landingHeadline: "在可审计决策室里评审复杂技术选择。",
    landingSublead:
      "QuorumMind 让多个模型和智能体先独立提案，再互评、挑刺、修订，最后把 ADR、蓝图、风险账本、权限审计和可导出的最终方案沉淀下来。",
    landingMetricAlgorithms: "9 类",
    landingMetricAlgorithmsLabel: "Borda / AHP / TOPSIS 等透镜",
    landingMetricAgents: "5+ 席",
    landingMetricAgentsLabel: "Agent、Provider、CLI 与 GitHub skeleton",
    landingMetricThreshold: "80%",
    ...
    landingTrace: "过程透明",
    landingTraceText: "展示来源状态、模型轨迹、共识轮次、权限门、配置摘要和兜底标识。",
    workspaceLabel: "工作区",
